...
The following datasets are provided in the [Datasets](/Supplementary Materials/Datasets) folder:
* Total coronavirus cases per UTLA – [Coronavirus_data](/Supplementary Materials/Datasets/Coronavirus_data.csv)
* Metadata including population and land area data for the 68 chosen UTLA’s – [Metadata](/Supplementary Materials/Dataset/metadata.csv)
* Access to private gardens and parks data - [Park access](/Supplementary Materials/Datasets/Park_access.csv)
* Green space percentage cover data – [Greenspace](/Supplementary Materials/Datasets/greenspace.csv)
* The final datasets:
  * [Final dataset for London](/Supplementary Materials/Datasets/Final_Data_London.csv)
  * [Final dataset excluding London](/Supplementary Materials/Datasets/Final_Data_Outside_London.csv)
